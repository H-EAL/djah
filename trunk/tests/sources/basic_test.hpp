...
private:
	template<typename P>
	void initPrimitive(djah::opengl::vertex_buffer *&pVB, djah::opengl::vertex_array &pVA, const std::string &textureFile, djah::d3d::texture_sptr &pTex, int level1 = 0, int level2 = 0);
...
private:
	...
	djah::resources::mesh_sptr	pBlockMesh;
	djah::resources::mesh_sptr	pGridMesh;
	djah::d3d::texture_sptr		pCowTexture_;
};
