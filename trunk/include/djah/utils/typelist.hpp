...
#define TYPELIST_4(T1,T2,T3,T4) djah::utils::typelist<T1, TYPELIST_3(T2,T3,T4) >
#define TYPELIST_5(T1,T2,T3,T4,T5) djah::utils::typelist<T1, TYPELIST_4(T2,T3,T4,T5) >
#define TYPELIST_6(T1,T2,T3,T4,T5,T6) djah::utils::typelist<T1, TYPELIST_5(T2,T3,T4,T5,T6) >
