...
namespace djah { namespace math {
	...
	//----------------------------------------------------------------------------------------------
	template<typename T>
	inline matrix<4,4,T> make_rotation(radian angle, vector<3,T> axis)
	{
		axis.normalize();
	...
	//----------------------------------------------------------------------------------------------
	template<typename T>
	inline matrix<4,4,T> make_rotation(radian angle, const vector<4,T> &axis)
	{
		return make_rotation(angle, resize<3>(axis));
	}
	//----------------------------------------------------------------------------------------------
	template<typename T>
	inline matrix<4,4,T> make_rotation(radian angle, T t_x, T t_y, T t_z)
	{
