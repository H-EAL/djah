...
.build-conf: ${BUILD_SUBPROJECTS}
	${MAKE}  -f nbproject/Makefile-Release.mk dist/../../../../lib/linux/libdjah_filesystem.a

dist/../../../../lib/linux/libdjah_filesystem.a: ${OBJECTFILES}
	${MKDIR} -p dist/../../../../lib/linux
	${RM} dist/../../../../lib/linux/libdjah_filesystem.a
	${AR} rv ${CND_DISTDIR}/../../../../lib/linux/libdjah_filesystem.a ${OBJECTFILES} 
	$(RANLIB) dist/../../../../lib/linux/libdjah_filesystem.a
...
${OBJECTDIR}/_ext/_DOTDOT/_DOTDOT/_DOTDOT/sources/filesystem/directory_source.o: nbproject/Makefile-${CND_CONF}.mk ../../../sources/filesystem/directory_source.cpp 
	...
	${RM} $@.d
	$(COMPILE.cc) -O2 -I../../../include/djah -I../../../../extlibs/include -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/_DOTDOT/_DOTDOT/_DOTDOT/sources/filesystem/directory_source.o ../../../sources/filesystem/directory_source.cpp
...
${OBJECTDIR}/_ext/_DOTDOT/_DOTDOT/_DOTDOT/sources/filesystem/file_stream.o: nbproject/Makefile-${CND_CONF}.mk ../../../sources/filesystem/file_stream.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/_DOTDOT/_DOTDOT/_DOTDOT/sources/filesystem
	${RM} $@.d
	$(COMPILE.cc) -O2 -I../../../include/djah -I../../../../extlibs/include -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/_DOTDOT/_DOTDOT/_DOTDOT/sources/filesystem/file_stream.o ../../../sources/filesystem/file_stream.cpp
...
${OBJECTDIR}/_ext/_DOTDOT/_DOTDOT/_DOTDOT/sources/filesystem/browser.o: nbproject/Makefile-${CND_CONF}.mk ../../../sources/filesystem/browser.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/_DOTDOT/_DOTDOT/_DOTDOT/sources/filesystem
	${RM} $@.d
	$(COMPILE.cc) -O2 -I../../../include/djah -I../../../../extlibs/include -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/_DOTDOT/_DOTDOT/_DOTDOT/sources/filesystem/browser.o ../../../sources/filesystem/browser.cpp
...
${OBJECTDIR}/_ext/_DOTDOT/_DOTDOT/_DOTDOT/sources/filesystem/memory_stream.o: nbproject/Makefile-${CND_CONF}.mk ../../../sources/filesystem/memory_stream.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/_DOTDOT/_DOTDOT/_DOTDOT/sources/filesystem
	${RM} $@.d
	$(COMPILE.cc) -O2 -I../../../include/djah -I../../../../extlibs/include -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/_DOTDOT/_DOTDOT/_DOTDOT/sources/filesystem/memory_stream.o ../../../sources/filesystem/memory_stream.cpp
...
${OBJECTDIR}/_ext/_DOTDOT/_DOTDOT/_DOTDOT/sources/filesystem/compression_techniques.o: nbproject/Makefile-${CND_CONF}.mk ../../../sources/filesystem/compression_techniques.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/_DOTDOT/_DOTDOT/_DOTDOT/sources/filesystem
	${RM} $@.d
	$(COMPILE.cc) -O2 -I../../../include/djah -I../../../../extlibs/include -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/_DOTDOT/_DOTDOT/_DOTDOT/sources/filesystem/compression_techniques.o ../../../sources/filesystem/compression_techniques.cpp
