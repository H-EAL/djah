...
.build-conf: ${BUILD_SUBPROJECTS}
	${MAKE}  -f nbproject/Makefile-Release.mk dist/../../../../lib/linux/libdjah_core.a

dist/../../../../lib/linux/libdjah_core.a: ${OBJECTFILES}
	${MKDIR} -p dist/../../../../lib/linux
	${RM} dist/../../../../lib/linux/libdjah_core.a
	${AR} rv ${CND_DISTDIR}/../../../../lib/linux/libdjah_core.a ${OBJECTFILES} 
	$(RANLIB) dist/../../../../lib/linux/libdjah_core.a
...
${OBJECTDIR}/_ext/media/Windows_Data__OS_/Development/djah/trunk/sources/time/clock.o: nbproject/Makefile-${CND_CONF}.mk /media/Windows\ Data\ \(OS\)/Development/djah/trunk/sources/time/clock.cpp 
	...
	${RM} $@.d
	$(COMPILE.cc) -O2 -I../../../include/djah -I../../../../extlibs/include -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/media/Windows_Data__OS_/Development/djah/trunk/sources/time/clock.o /media/Windows\ Data\ \(OS\)/Development/djah/trunk/sources/time/clock.cpp
...
${OBJECTDIR}/_ext/media/Windows_Data__OS_/Development/djah/trunk/sources/utils/randomizer.o: nbproject/Makefile-${CND_CONF}.mk /media/Windows\ Data\ \(OS\)/Development/djah/trunk/sources/utils/randomizer.cpp 
	...
	${RM} $@.d
	$(COMPILE.cc) -O2 -I../../../include/djah -I../../../../extlibs/include -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/media/Windows_Data__OS_/Development/djah/trunk/sources/utils/randomizer.o /media/Windows\ Data\ \(OS\)/Development/djah/trunk/sources/utils/randomizer.cpp
