...
${OBJECTDIR}/_ext/_DOTDOT/_DOTDOT/_DOTDOT/tests/sources/application.o: nbproject/Makefile-${CND_CONF}.mk ../../../tests/sources/application.cpp 
	...
	${RM} $@.d
	$(COMPILE.cc) -g -I../../../include -I../../../../extlibs/include -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/_DOTDOT/_DOTDOT/_DOTDOT/tests/sources/application.o ../../../tests/sources/application.cpp
